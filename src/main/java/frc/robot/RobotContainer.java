...
public class RobotContainer {
  ...
  justShoot = "just shoot", AedynsAuto = "AedynsAuto";
  ...
  public RobotContainer() {
    ...
    m_chooser.addOption(AedynsAuto, AedynsAuto);
  ...
  public Command getAutonomousCommand() {
    System.out.println("Autos Begun");
      ...
      if(m_autoSelected == justShoot)
        ...
        if(m_autoSelected == AedynsAuto)
        return AutoBuilder.buildAuto("AedynsAuto");
